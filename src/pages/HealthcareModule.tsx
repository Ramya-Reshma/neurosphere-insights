...
export default function HealthcareModule() {
  ...
  const handleExportPDF = () => {
    ...
    generatePDFReport({
      module: 'Healthcare - Patient Cognitive Monitoring',
      subjectName: details.patientName,
  ...
  return (
    <div className="p-6 lg:p-8 max-w-4xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-neuro-rose to-neuro-amber flex items-center justify-center">
      ...
      {step === 'results' && result && eegData && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-5">
          ...
          <ResultsDisplay result={result} recommendations={recommendations} moduleType="healthcare" />
